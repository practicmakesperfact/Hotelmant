...
export const mockMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    isSpicy: true,
    preparationTime: 15,
    image: 'https://images.unsplash.com/photo-1633504581200-a9796e6d773c?q=80&w=800',
  },
  {
    id: 'food-007',
  ...
  },
  {
    ...
    nameAm: 'የኢትዮጵያ ቡና ሥነ-ሥርዓት',
    nameOm: 'Sirna Buna Itoophiyaa',
    category: 'restaurant',
    foodCategory: 'hot_drinks',
    description: 'Traditional coffee ceremony experience with freshly roasted beans and popcorn.',
    price: 150,
    chargeType: 'per_item',
    isAvailable: true,
    ingredients: ['Coffee Beans', 'Water', 'Frankincense', 'Popcorn'],
    portionSize: 'Ceremony',
    isVegetarian: true,
    isSpicy: false,
    preparationTime: 15,
  ...
  },
  {
    ...
    name: 'Ginger Tea',
    nameAm: 'የዝንጅብል ሻይ',
    nameOm: 'Shaayii Jinjibilaa',
    category: 'restaurant',
    foodCategory: 'hot_drinks',
    description: 'Soothing hot tea infused with fresh ginger and honey.',
    price: 60,
    chargeType: 'per_item',
    isAvailable: true,
    ingredients: ['Tea Leaves', 'Fresh Ginger', 'Honey', 'Lemon'],
    portionSize: '250ml',
    isVegetarian: true,
    isSpicy: true,
    preparationTime: 5,
  ...
  },
  {
    ...
    name: 'Habesha Beer',
    nameAm: 'ሐበሻ ቢራ',
    nameOm: 'Biiraa Habashaa',
    category: 'restaurant',
    foodCategory: 'alcoholic_beverage',
    description: 'Cold, refreshing local Ethiopian beer.',
    price: 85,
    chargeType: 'per_item',
    isAvailable: true,
  ...
  },
  {
    ...
    nameAm: 'ትኩስ የፍራፍሬ ድብልቅ',
    nameOm: 'Furaatiraa Adda addaa',
    category: 'restaurant',
    foodCategory: 'juice_fruit',
    description: 'Assortment of seasonal tropical fruits including papaya, mango, and avocado.',
    price: 180,
    chargeType: 'per_item',
    isAvailable: true,
    ingredients: ['Papaya', 'Mango', 'Avocado', 'Pineapple', 'Lemon'],
    portionSize: 'Regular',
    isVegetarian: true,
    isSpicy: false,
    preparationTime: 10,
    image: 'https://images.unsplash.com/photo-1511688827399-c3f88a03c0d9?q=80&w=800',
  },
  {
    id: 'food-013',
    name: 'Ambo Water (Sparkling)',
    nameAm: 'አምቦ ውሃ',
    nameOm: 'Bishaan Amboo',
    category: 'restaurant',
    foodCategory: 'water',
    description: 'Famous Ethiopian naturally sparkling mineral water.',
    price: 45,
    chargeType: 'per_item',
    isAvailable: true,
  ...
  },
  {
    ...
    nameAm: 'ምርጥ ነጭ ወይን',
    nameOm: 'Wayinii Adi Filatamaa',
    category: 'restaurant',
    foodCategory: 'alcoholic_beverage',
    description: 'Chilled dry white wine, perfect for pairing with international dishes.',
    price: 1200,
    chargeType: 'per_item',
    isAvailable: true,
    ingredients: ['Grapes'],
...
// Organizations (for corporate bookings)
export const mockOrganizations = [
  {
    id: 'org-001',
    name: 'Ethiopian Airlines',
    contactPerson: 'Ato Bekele Hailu',
    email: 'corporate@ethiopianairlines.com',
    phone: '+251116179900',
...
export const mockGalleryItems = [
  {
    ...
    panoramaUrl: '/360/presidential-suite.jpg',
    is360: true,
    hotspots: [
      { id: 'hs-001', x: 30, y: 50, title: 'King Bed', description: 'Premium king-size bed with luxury linens', icon: 'bed' },
      { id: 'hs-002', x: 70, y: 40, title: 'Balcony', description: 'Private balcony with mountain views', icon: 'door' },
    ],
  ...
  },
  {
    ...
    description: 'Elegant dining space with traditional Ethiopian decor',
  ...
  },
  {
    ...
    description: 'Relaxing spa facilities with traditional treatments',
...
// Conference Halls
export const mockConferenceHalls = [
  {
    id: 'hall-001',
    name: 'Grand Ballroom',
    capacity: 500,
    size: 600,
    amenities: ['Projector', 'Sound System', 'Stage', 'WiFi', 'AC', 'Catering Service'],
    pricePerHour: 5000,
    pricePerDay: 35000,
    images: ['https://images.unsplash.com/photo-1505373877841-8d25f7d46678?q=80&w=800'],
    isAvailable: true,
  },
  {
    id: 'hall-002',
    ...
    capacity: 50,
    size: 80,
    amenities: ['Smart TV', 'Video Conferencing', 'Whiteboard', 'WiFi', 'AC'],
    pricePerHour: 1500,
    pricePerDay: 10000,
...
export const mockEvents = [
  {
    ...
    organizerId: 'org-001',
    organizerName: 'Ethiopian Airlines',
    organizerEmail: 'corporate@ethiopianairlines.com',
    organizerPhone: '+251116179900',
    ...
    notes: 'Requires AV setup by 8 AM',
  ...
  },
  {
    ...
    hallId: 'hall-001',
    hallName: 'Grand Ballroom',
    organizerId: 'cust-001',
    organizerName: 'Yohannes Gebremedhin',
    organizerEmail: 'customer@example.com',
    organizerPhone: '+251966778899',
    startDate: addDays(today, 45),
    endDate: addDays(today, 45),
    numberOfGuests: 250,
    services: ['svc-001', 'svc-005', 'svc-006'],
    totalAmount: 200000,
    paidAmount: 100000,
    status: 'confirmed' as const,
...
export const mockReviews = [
  {
    ...
    value: 5,
    location: 5,
    comment: 'Exceptional service and beautiful rooms. The staff went above and beyond to make our stay comfortable. Highly recommend!',
    response: 'Thank you for your wonderful review! We are delighted to hear you enjoyed your stay.',
    respondedBy: 'staff-001',
    respondedAt: subDays(today, 1),
  ...
  },
  {
    ...
    value: 4,
    location: 5,
    comment: 'Great hotel with excellent location. The room was clean and comfortable. Only minor issue was the WiFi speed.',
    status: 'approved' as const,
    createdAt: subDays(today, 5),
  },
  {
    ...
    value: 5,
    location: 5,
    comment: 'The Presidential Suite exceeded all expectations. Impeccable service, stunning views, and world-class amenities. Will definitely return!',
    response: 'We are honored by your kind words! Looking forward to welcoming you back.',
    respondedBy: 'staff-002',
    respondedAt: subDays(today, 3),
    status: 'approved' as const,
...
export const mockPromotions = [
  ...
  },
  {
    ...
    description: 'ETB 500 off on weekend bookings',
  ...
  },
  {
    ...
    description: '20% off for stays of 5 nights or more',
    discountType: 'percentage' as const,
    discountValue: 20,
...
export const mockAuditLogs = [
  {
    id: 'audit-001',
    userId: 'staff-003',
    userName: 'Meskerem Tadesse',
    action: 'check_in',
    entity: 'booking',
    entityId: 'BK-2024-001',
    changes: { status: { from: 'confirmed', to: 'checked_in' } },
  ...
  },
  {
    ...
    entity: 'room',
    entityId: 'room-501',
    changes: { pricePerNight: { from: 14000, to: 15000 } },
